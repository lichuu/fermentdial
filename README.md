...
Join that network from a phone or laptop, open the setup page, enter your home Wi-Fi credentials, and the device will save them to NVS and reboot.

After it joins your Wi-Fi, the Dial settings menu shows the assigned IP address under `Wi-Fi`. Open that IP address in a browser to see the local web UI.
